...
// and 32 entries for two GDT entries
...
// TODO: replace 8192 with a macro for page size
var rsp0: [lib.PAGE_SIZE * 2]u8 = undefined;
...
pub fn init(cpu_count: u64) void {
    ...
    // Update metadata in TSS
    tss.rsp0 = @intFromPtr(&rsp0[4096]);
    tss.iopb = @sizeOf(Tss);
    ...
    gdt_entries[5] = tss_entry_lower.*;
    gdt_entries[6] = tss_entry_upper.*;
